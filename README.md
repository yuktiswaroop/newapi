...
```
##### It comes with a custom management command to populate the database with some dummy data, 
##### and an API to serve that data in the json format given above.

####  *Concepts Used:*
- Serializer Nested Relationships
- Faker package - a Python package that generates fake data.
